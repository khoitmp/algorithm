...
namespace Algorithm.Lib
{
    ...
    internal class HashTableArrayNode<TKey, TValue>
    {
        ...
        /// <summary>
        /// Return an enumerator for all of the values in the list
        /// </summary>
        ...
        /// <summary>
        /// Return an enumerator for all of the keys in the list
        /// </summary>
        ...
        /// <summary>
        /// Return an enumerator for all the key/value pairs in the list
        /// </summary>
        ...
        /// <summary>
        /// Update the value of the existing key/value pair in the list.
        ...
        /// <summary>
        /// Remove the item from the list whose key matches
        /// the specified key
        /// </summary>
